...
let UserRepository = class UserRepository {
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield users_model_1.Users.findAll();
        });
    }
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield users_model_1.Users.findByPk(id);
        });
    }
    create(_a) {
        return __awaiter(this, arguments, void 0, function* ({ email, password, roleId }) {
            return yield users_model_1.Users.create({ email, password, roleId });
        });
    }
    update(id_1, _a) {
        return __awaiter(this, arguments, void 0, function* (id, { email, password, roleId }) {
            yield users_model_1.Users.update({ email, password, roleId }, { where: { id } });
        });
    }
    destroy(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield users_model_1.Users.destroy({ where: { id } });
        });
    }
    getOrdersByUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
